 ...
 */
class My_Ibanner_Model_Mysql4_Banner_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract {
    /**
     * Constructor method
     */
    protected function _construct() {
        $this->_init('ibanner/banner');
    }
     ...
     * @return My_Ibanner_Model_Mysql4_Banner_Collection
     */
    ...
    public function addCategoryFilter($category) {
        $this->getSelect()->join(
                array('category_table' => $this->getTable('ibanner/banner_category')),
    ...
    public function addPageFilter($page) {
        $this->getSelect()->join(
                array('page_table' => $this->getTable('ibanner/banner_page')),
    ...
    public function addStoreFilter($store) {
        if (!Mage::app()->isSingleStoreMode()) {
            ...
            $this->getSelect()->join(
                    array('store_table' => $this->getTable('ibanner/banner_store')),
