 ...
 */
class My_Ibanner_Model_Banner_Image extends Mage_Core_Model_Abstract
{
    protected $_width;
    protected $_height;
    ...
    {
        $this->_init('ibanner/banner_image');
    }
...
//        print '$this->_getNeedMemoryForBaseFile() = '.$this->_getNeedMemoryForBaseFile();
    ...
    public function setBaseFile($file)
    {
        ...
        $baseDir = Mage::getSingleton('ibanner/config')->getBaseMediaPath();
...
//            }
    ...
    public function clearCache()
    {
        ...
        $directory = Mage::getSingleton('ibanner/config')->getBaseMediaPath() .DS.'cache'.DS;
