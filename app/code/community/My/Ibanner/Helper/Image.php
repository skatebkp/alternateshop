 ...
 */
class My_Ibanner_Helper_Image extends Mage_Core_Helper_Abstract
{
    protected $_model;
    ...
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('ibanner/banner_image'));
     ...
     *
     * @see My_Ibanner_Model_Banner_Image
     * @param int $width
     * @param int $height
     * @return My_Ibanner_Helper_Image
     */
