...
class Commercebug_Packager
{
    ...
    {
        $string = '<?xml version="1.0" encoding="UTF-8"?><config><modules><Irohleder_Commercebug><active>true</active><codePool>local</codePool></Irohleder_Commercebug></modules></config>';
        $string = str_replace('Irohleder_', $this->namespace . '_',$string);
