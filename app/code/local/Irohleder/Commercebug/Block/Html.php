...
class Irohleder_Commercebug_Block_Html extends Mage_Core_Block_Template
{	
    ...
    {
        $paths_to_check = array(Mage::getBaseDir('design'),Mage::getModuleDir('', 'Irohleder_Commercebug'));
        $valid			= false;
    ...
    {	    	
        $module_dir = Mage::getModuleDir('', 'Irohleder_Commercebug');
