...
*/
class Irohleder_Commercebug_Model_Collectorblocksandlayout extends Irohleder_Commercebug_Model_Observingcollector
{
    ...
    {		
        ...
        foreach($this->_blocks as $block)
        {
            ...
            if(strpos($class,'Irohleder_Commercebug') === 0)
            {
                continue;
            }
